...
namespace SIGA\MigrationsGenerator\Generators\Commands;

use Symfony\Component\Console\Input\InputOption;
use Symfony\Component\Console\Input\InputArgument;

use SIGA\MigrationsGenerator\Generators\Generator;
use SIGA\MigrationsGenerator\Generators\Filesystem\Filesystem;
use SIGA\MigrationsGenerator\Generators\Compilers\TemplateCompiler;
use Illuminate\Database\Migrations\MigrationRepositoryInterface;

use SIGA\MigrationsGenerator\Generators\SchemaGenerator;
use SIGA\MigrationsGenerator\Generators\Syntax\AddToTable;
use SIGA\MigrationsGenerator\Generators\Syntax\DroppedTable;
use SIGA\MigrationsGenerator\Generators\Syntax\AddForeignKeysToTable;
use SIGA\MigrationsGenerator\Generators\Syntax\RemoveForeignKeysFromTable;
...
class MigrateGenerateCommand extends GeneratorCommand
{
    ...
    /**
     * @var \SIGA\MigrationsGenerator\Generators\Filesystem\Filesystem
     */
    protected $file;

    /**
     * @var \SIGA\MigrationsGenerator\Generators\Compilers\TemplateCompiler
     */
    protected $compiler;
    ...
    /**
     * @var \SIGA\MigrationsGenerator\Generators\SchemaGenerator
     */
    ...
    /**
     * @param \SIGA\MigrationsGenerator\Generators\Generator  $generator
     * @param \SIGA\MigrationsGenerator\Generators\Filesystem\Filesystem  $file
     * @param \SIGA\MigrationsGenerator\Generators\Compilers\TemplateCompiler  $compiler
     * @param $config
     */
    ...
    {
        $excludes = ['migrations','password_resets','failed_jobs','tenants','roles','permissions','files','sliders','translations','makes'];
