        ...
        */
        public function fields()
        {
            return [
                ...
                Select::make('president_id')->target(Councilor::query()),
                Select::make('first_secretary_id')->target(Councilor::query()),
                Select::make('last_secretary_id')->target(Councilor::query()),
                Select::make('member_id')->target(Councilor::query()),
