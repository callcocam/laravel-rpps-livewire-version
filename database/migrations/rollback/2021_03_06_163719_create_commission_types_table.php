...
class CreateCommissionTypesTable extends Migration {
	...
	Schema::create('commission_types', function(Blueprint $table)
			{
                $table->increments('id');
			$table->integer('company_id')->unsigned()->nullable()->index('commission_types_company_id_foreign');
			$table->integer('user_id')->unsigned()->nullable()->index('commission_types_user_id_foreign');
