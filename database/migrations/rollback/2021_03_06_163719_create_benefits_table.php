...
class CreateBenefitsTable extends Migration {
	...
	Schema::create('benefits', function(Blueprint $table)
			...
			$table->integer('benefit_rule_id')->nullable()->index('fk_benefit_rules_benefits_benefit_rule_id')->comment('campo da tabela benefit_rules, onde traz o id do benefício: aposentadoria por idade, tempos, etc...');
